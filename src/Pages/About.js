          ...
          <Container>
            ...
            <SubContainer>
              <Box>
                <VerifiedIcon/> 
                <Typography>
                  Cuisine Cruise offers delivery of <strong>delicious and healthy food.</strong> 
                </Typography>
              </Box>
              <Box>
                <VerifiedIcon/>
            ...
            <IconContainer>
              <a href="https://www.instagram.com/pranavwaykar.io/"> <InstagramIcon sx={{cursor:'pointer', color: 'rgb(211,47,47)'}} /></a>
              <a href="https://github.com/pranavwaykar"><GitHubIcon sx={{cursor:'pointer', color:'black'}} /></a>
              <a href="linkedin.com/in/pranavwaykar/"><LinkedInIcon sx={{ cursor: 'pointer', color: '#0A66C2' }} /></a>
              <a href="mailto:waykarpranav777@gmail.com"><MailOutlineIcon sx={{ cursor: 'pointer', color: 'red' }}/></a>
            </IconContainer>
          </Container>
        </HeaderBox>
      </MainContainer>
