...
const HeaderBox = styled(Toolbar)`
  ...
  background-image: linear-gradient(
    to top,
    rgba(238, 194, 174, 0) 0%,
    rgba(230, 99, 103, 0.3) 100%
  );
`;
    ...
    <AppBar sx={{ boxShadow: "none" }}>
      <HeaderBox>
        <FoodLogoBox>
          ...
          />
          <HeadingBox>
            <Typography>Cuisine Cruise</Typography>
            <Typography>Your On-Demand Culinary Adventure</Typography>
          </HeadingBox>
        </FoodLogoBox>
        ...
        <NavItems>
          <ul>
            ...
            <li>
              <NavLink style={navLinkStyle} to="/restaurants">
                Menu
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink style={navLinkStyle} to="/help">
                Help
              </NavLink>
            </li>
            <li>
