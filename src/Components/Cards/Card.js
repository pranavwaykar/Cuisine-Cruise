    ...
    <RestCard >
      ...
      <CardInfo>
        <h2>{name}</h2>
         ...
         <Typography sx={{ fontFamily: 'Quicksand',  color: 'grey',   
          textAlign: 'inherit'}}>
          {cuisines.join(", ")}
        </Typography>

        <Typography sx={{ fontFamily: 'Quicksand',  color: 'grey' }}>{areaName}, {Area}</Typography>
        ...
        <RatingContainer>
          ...
          <Box sx={{display : 'flex', fontFamily: 'Quicksand', color: 'grey', gap : '5px' }}>
          <Typography sx={{fontFamily: 'Quicksand',  }}>{sla?.lastMileTravelString ?? '2.0 km'}</Typography>
          </Box>
